...
//    в продаже меньше самого малого среднего количества продуктов
//    в деталях заказов (группировка по product_id).
//    Результирующая таблица должна иметь колонки product_name и units_in_stock.

//    а. Написали подзапрос, выяснили  самое малое среднее количества продуктов в деталях заказов
...
// Условие WHERE units_in_stock < ALL (...) проверяет, что количество на складе меньше всех значений, возвращаемых подзапросом.

// 2. Напишите запрос, который выводит общую сумму фрахтов заказов
//    для компаний-заказчиков для заказов, стоимость фрахта которых больше
